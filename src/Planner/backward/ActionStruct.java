...
import Planner.*;
import Planner.backward.Actions;
...
public class ActionStruct {
    String name;
    String format;
    String prerequsiteString;
    ArrayList<String> prerequisites;
    ArrayList<String> args;
    ArrayList<String> effects;
    ArrayList<String> requirements;
    
    public ActionStruct(String name, ArrayList<String> prerequsite, String format, ArrayList<String> args, ArrayList<String> effects, ArrayList<String> requirements) {
